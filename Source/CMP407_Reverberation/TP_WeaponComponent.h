...
public:
	...
	TSubclassOf<class ACMP407_ReverberationProjectile> ProjectileClass;
	...
	bool AttachWeapon(ACMP407_ReverberationCharacter* TargetCharacter);
...
private:
	...
	ACMP407_ReverberationCharacter* Character;
};
